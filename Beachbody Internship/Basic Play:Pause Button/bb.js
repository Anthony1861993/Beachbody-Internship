...
bb_plugin.BBPlayerPlugin = Class.extend({
    ...
    initialize: function(loadObj) { // PDK Controller setup
        ...
        this.overlayButton.className = "bb-overlay-button bb-button-button-large";
        this.overlayButton.innerHTML =  "PAUSE";
        this.overlay.appendChild(this.overlayButton);
        $(this.overlayButton).on("click", function(){ self.togglePlay(); });


        this.controller.addEventListener("OnMediaPlaying", function(){ self.handleMediaPlaying.apply(self, arguments);});
        this.controller.addEventListener("OnMediaPause", function(){ self.togglePlay(); self.isPaused = true;  self.updatePlayButtons(); });
        this.controller.addEventListener("OnMediaUnpause", function(){ self.togglePlay(); self.isPaused = false; self.updatePlayButtons(); });
    ...
    initOverlay: function() {
        ...
        this.overlay.className = "bb-overlay";
		...
		if(hideControls){
            ...
            this.overlayButton.setAttribute("style", "opacity:0");
		}
    ...
    updatePlayButtons: function() {
        if (this.isPaused) {
            ...
            //$(this.overlayButton).innerHTML = "asas";
        } else {
    ...
    togglePlay: function() { 
        this.overlayButton.innerHTML = (this.isPaused)? "PAUSE": "PLAY";
