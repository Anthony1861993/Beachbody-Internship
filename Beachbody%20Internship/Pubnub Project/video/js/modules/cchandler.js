define(['jquery','menu','cookie'], function($,menu,cookie){
	...
	cchandler.prototype.processCCTracks = function(trackList) {
		...
		adjustedTrackList[0] = {markup:"Subtitles   <a href='#' onclick='openStylesMenuGlobal()' class='menu_title_link'>|   Options</a>", type:UI_MENU_ITEM_TYPES.menu_item_title};
	...
	cchandler.prototype.menuItemSelectHandler = function(textTrackIndex) {
		...
		if (textTrackIndex > 0) {
			if (textTrackIndex === 1) {
				...
				cookie.setCookie("subtitles", textTrackIndex, INTERVAL_2_DAY_MS); // Set cookie here.
			} else {
