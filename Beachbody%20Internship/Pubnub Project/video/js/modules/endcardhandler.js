define(['jquery'], function($){
	...
	endcardhandler.prototype.updateEndCardProgram = function(programName){
		$("#endCardText").html("<span class='end_card_text_title'>NEXT VIDEO</span><br/>"+programName);
	}	
